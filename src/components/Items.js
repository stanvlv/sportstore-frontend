  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      >
        ...
        >
          <Dropdown.Item
            onClick={() => filterTheData("Football")}
            active={activeCategory === "Football"}
          >
            Football
          </Dropdown.Item>
          <Dropdown.Item
            onClick={() => filterTheData("Tennis")}
            active={activeCategory === "Tennis"}
          >
            Tennis
          </Dropdown.Item>
          <Dropdown.Item
            onClick={() => filterTheData("Swimming")}
            active={activeCategory === "Swimming"}
          >
            Swimming
          </Dropdown.Item>
          <Dropdown.Item
            onClick={() => filterTheData("Basketball")}
            active={activeCategory === "Basketball"}
          >
            Basketball
          </Dropdown.Item>
          <Dropdown.Item
            onClick={() => filterTheData("Cycling")}
            active={activeCategory === "Cycling"}
          >
            Cycling
          </Dropdown.Item>
        </DropdownButton>
              ...
              <Link className="nav-link" to={`/items/${item._id}`}>
                <Card style={{ marginBottom: "2rem", maxWidth: "275px" }}>
                  <Card.Img
                    ...
                    style={{ maxHeight: "225px", maxWidth: "325px" }}
                  />
                  <Card.Body>
                    <Card.Text
                      style={{
